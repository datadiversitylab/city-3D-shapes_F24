...
ggline(msel, x = "Shape", y = "Mean",
       ...
       add= "mean_se", group = 1,
       ylab = "UHI Cityshape wise Group Mean", xlab = "City Shape")+
  geom_line(data = m1_sum , aes(x=Shape, y=Meanvar, group=1))+
  labs(title = "Box plot of UHI Day and Night group meanvalues " , 
       subtitle = "Based on cityshape wise group means and standard error")+
  theme(legend.position = "none",
        panel.grid = element_blank(),
        panel.border = element_rect(colour = "black", fill = NA),
        panel.background = element_rect(fill = "azure"),
