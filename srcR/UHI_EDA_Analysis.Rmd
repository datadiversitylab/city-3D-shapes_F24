...
ggplot(data = world) +
  ...
  scale_color_manual( labels= c("⌛ Hourglass" , "Inverse Pyramid" , "▼️ Inverse Pyramid" ,  
                                "▲ Pyramid" ,  "♦ Diamond" ,"  Unknown"),
  ...
  theme(legend.position = "top",
        legend.text=element_text(size=20, color= "darkgreen"  ),
...
ggsave("../data/11_Output_R/CityShapesInWordMap.png")
...
ggsave("../data/11_Output_R/Aalborg_UHI_DayNight_plot.png")    
  ...
  ggplot(data = swater ,
    ...
    geom_tile() +
    scale_fill_gradient( "waterClass",low = "skyblue", high = "navy")+    
    labs(title = "Day time UHI", subtitle = "for city Aalborg")+    
